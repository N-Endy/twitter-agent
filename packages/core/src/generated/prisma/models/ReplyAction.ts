...
// @ts-nocheck 
/*
 * This file exports the `ReplyAction` model and its related types.
 *
...
export type GetReplyActionAggregateType<T extends ReplyActionAggregateArgs> = {
      [P in keyof T & keyof AggregateReplyAction]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateReplyAction[P]>
    : Prisma.GetScalarType<T[P], AggregateReplyAction[P]>
}
...
type GetReplyActionGroupByPayload<T extends ReplyActionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ReplyActionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ReplyActionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ReplyActionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ReplyActionGroupByOutputType[P]>
      }
    >
  >
...
export type ReplyActionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ReplyActionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ReplyActionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ReplyAction'], meta: { name: 'ReplyAction' } }
  /**
   ...
   * })
  **/
  count<T extends ReplyActionCountArgs>(
    args?: Prisma.Subset<T, ReplyActionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ReplyActionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ReplyActionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ReplyActionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetReplyActionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
