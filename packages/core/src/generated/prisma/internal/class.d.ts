...
export interface PrismaClient<in LogOpts extends Prisma.LogLevel = never, in out OmitOpts extends Prisma.PrismaClientOptions['omit'] = undefined, in out ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> {
    ...
    /**
 * `prisma.sourceItem`: Exposes CRUD operations for the **SourceItem** model.
  * Example usage:
  * ```ts
  * // Fetch zero or more SourceItems
  * const sourceItems = await prisma.sourceItem.findMany()
  * ```
  */
    get sourceItem(): Prisma.SourceItemDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.researchSnapshot`: Exposes CRUD operations for the **ResearchSnapshot** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more ResearchSnapshots
      * const researchSnapshots = await prisma.researchSnapshot.findMany()
      * ```
      */
    get researchSnapshot(): Prisma.ResearchSnapshotDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.contentIdea`: Exposes CRUD operations for the **ContentIdea** model.
      ...
      * ```
      */
    get contentIdea(): Prisma.ContentIdeaDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.draftReview`: Exposes CRUD operations for the **DraftReview** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more DraftReviews
      * const draftReviews = await prisma.draftReview.findMany()
      * ```
      */
    get draftReview(): Prisma.DraftReviewDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.scheduleSlot`: Exposes CRUD operations for the **ScheduleSlot** model.
      ...
      * ```
      */
    get scheduleSlot(): Prisma.ScheduleSlotDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.publishedPost`: Exposes CRUD operations for the **PublishedPost** model.
      ...
      * ```
      */
    get publishedPost(): Prisma.PublishedPostDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.postMetric`: Exposes CRUD operations for the **PostMetric** model.
      ...
      * ```
      */
    get postMetric(): Prisma.PostMetricDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.replySuggestion`: Exposes CRUD operations for the **ReplySuggestion** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more ReplySuggestions
      * const replySuggestions = await prisma.replySuggestion.findMany()
      * ```
      */
    get replySuggestion(): Prisma.ReplySuggestionDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.replyAction`: Exposes CRUD operations for the **ReplyAction** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more ReplyActions
      * const replyActions = await prisma.replyAction.findMany()
      * ```
      */
    get replyAction(): Prisma.ReplyActionDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
